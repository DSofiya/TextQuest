...
class CharacterSelector:
    ...
    def load_buttons(self):
        buttons_data = [
            {"x": self.window_size[0] / 5, "y": self.window_size[0] / 8, "width": self.window_size[0] / 6,
             "height": self.window_size[0] / 5.8, "image_path": "Character\\Bard.png", "text": "Бард"},
            {"x": self.window_size[0] / 2.2, "y": self.window_size[0] / 8, "width": self.window_size[0] / 6,
             "height": self.window_size[0] / 5.8, "image_path": "Character\\Cleric.png", "text": "Клірик"},
            {"x": self.window_size[0] / 2.2, "y": self.window_size[0] / 3.2, "width": self.window_size[0] / 6,
             "height": self.window_size[0] / 5.8, "image_path": "Character\\Fighter.png", "text": "Воїн"},
            {"x": self.window_size[0] / 5, "y": self.window_size[0] / 3.2, "width": self.window_size[0] / 6,
             "height": self.window_size[0] / 5.8, "image_path": "Character\\Wizard.png", "text": "Чарівник"},
            {"x": self.window_size[0] / 1.35, "y": self.window_size[0] / 10, "width": self.window_size[0] / 10,
             "height": self.window_size[0] / 10, "image_path": "Character\\exit.png", "text": "Вихід до головного меню "}]
    ...
    def display_menu(self):
        ...
        while running:
            ...
            title_text = self.big_font.render("Обери клас персонажа", True, (255, 228, 181))
            window.blit(title_text, (self.window_size[0] / 3.5, self.window_size[0] / 9))
    ...
    def handle_button_click(self, button):
        ...
        if button == self.buttons[-1]:
            ...
            pygame.quit()
            subprocess.run(["python", "name_character.py"])
